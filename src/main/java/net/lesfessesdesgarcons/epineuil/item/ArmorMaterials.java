...
public class ArmorMaterials {
    public static final Holder<ArmorMaterial> CHICKEN_ARMOR = register("chicken", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
    ...
    public static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(EpiNeuil.MOD_ID, name);
